...
from .views import adminPanel, categoryPage, communityDiscussion, contest, index, instancefeadback, notificationreminder, problemsolvingmodule, profilemanagment, rewardsachievement
...
urlpatterns = [
    ...
    path("achievement/", contest, name="contest"),
    path("admin/", contest, name="contest"),
